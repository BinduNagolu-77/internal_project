 ...
 */
package com.hybris.grocerystore.core.constants;

/**
 * Global class for all GrocerystoreCore constants. You can add global constants for your extension into this class.
 */
public final class GrocerystoreCoreConstants extends GeneratedGrocerystoreCoreConstants
{
	public static final String EXTENSIONNAME = "grocerystorecore";


	private GrocerystoreCoreConstants()
	{
		//empty
	}
