 ...
 */
package com.hybris.grocerystore.fulfilmentprocess.test.jobs;
...
import com.hybris.grocerystore.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = GrocerystoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
