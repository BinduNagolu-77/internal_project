 ...
 */
package com.hybris.grocerystore.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, GrocerystoreFulfilmentProcessConstants.PARENT_PROCESS);
