 ...
 */
package com.hybris.grocerystore.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(GrocerystoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(GrocerystoreFulfilmentProcessConstants.PARENT_PROCESS);
