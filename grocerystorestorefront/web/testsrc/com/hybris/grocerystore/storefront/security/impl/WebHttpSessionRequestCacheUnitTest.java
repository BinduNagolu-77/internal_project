...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/grocerystorestorefront/electronics/en",
						"https://electronics.local:9002/grocerystorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/grocerystorestorefront/electronics/en",
						"https://electronics.local:9002/grocerystorestorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/grocerystorestorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/grocerystorestorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/grocerystorestorefront/electronics/en",
						"https://electronics.local:9002/grocerystorestorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/grocerystorestorefront",
						"https://electronics.local:9002/grocerystorestorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/grocerystorestorefront",
						"https://electronics.local:9002/grocerystorestorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/grocerystorestorefront/electronics/en",
						"https://electronics.local:9002/grocerystorestorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
