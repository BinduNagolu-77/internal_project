...
<li class="${fn:escapeXml(productTagClasses)}">
	<ycommerce:testId code="test_searchPage_wholeProduct">
		...
		<h5 style="color:blue">Weight : ${product.weight}&nbsp ${product.weightUnit}</h5>
		<h5 style="color:blue">ShelfLife : ${product.shelfLife}	</h5>
		<h5 style="color:blue">BrandName : ${product.brandName}	</h5>
