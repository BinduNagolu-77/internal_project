 ...
 */
package com.hybris.grocerystore.test.setup;
...
import com.hybris.grocerystore.test.constants.GrocerystoreTestConstants;
import com.hybris.grocerystore.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = GrocerystoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/grocerystoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/grocerystoretest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/grocerystoretest/import/cstickets.impex");
			...
			importImpexFile(context, "/grocerystoretest/import/csquotes.impex");
		}
	}
}
